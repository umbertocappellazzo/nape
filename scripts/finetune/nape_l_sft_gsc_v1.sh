...
EXPERIMENT_NAME="nape-large-finetune-gscv1"
WANDB_PROJECT=""
...
TRAIN_MANIFEST="/path/to/manifest/manifest_gscv1_train.json"
EVAL_MANIFEST="/path/to/manifest/manifest_gscv1_val.json"
TEST_MANIFEST="/path/to/manifest/manifest_gscv1_test.json"
...
PROBE_LAYER=""          # "last" / "weighted_sum" / int for linear probing; empty for SFT

export WANDB_PROJECT=$WANDB_PROJECT

echo "============================================"
echo "  Audio NAPE Large — GSC v1 KS1 (12-class)"
echo "  GPUs:          $NGPU"
