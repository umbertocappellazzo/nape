#!/bin/bash
# ========================
# Audio NAPE Small — Fine-tuning on AudioSet (AS-20K balanced)
# ========================
set -e
...
EXPERIMENT_NAME="nape-small-finetune-AS20K"
WANDB_PROJECT=""
...
# ---- Data ----
TRAIN_MANIFEST="/path/to/manifest/${DATASET_CONFIG}/train/manifest_AS20K_train.json"
EVAL_MANIFEST="/path/to/manifest/${DATASET_CONFIG}/test/manifest_AS_test.json"
#manifest_combined_test.json
...
echo "============================================"
echo "  Audio NAPE Small — Fine-tuning"
echo "  GPUs: $NGPU"
