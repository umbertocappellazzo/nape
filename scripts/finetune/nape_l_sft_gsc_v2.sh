...
EXPERIMENT_NAME="nape-large-finetune-gscv2"
WANDB_PROJECT=""
...
TRAIN_MANIFEST="/path/to/manifest/manifest_gscv2_train.json"
EVAL_MANIFEST="/path/to/manifest/manifest_gscv2_val.json"
TEST_MANIFEST="/path/to/manifest/manifest_gscv2_test.json"
CLASSES_FILE="/path/to/classes/classes_gscv2.json"
NORM_STATS_FILE="/path/to/stats/norm_stats_gscv2.json"
...
echo "============================================"
echo "  Audio NAPE Large — GSC v2 (35-class)"
echo "  GPUs:          $NGPU"
