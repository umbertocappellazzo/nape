...
EXPERIMENT_BASE="nape-large-linearprobing-esc50"
WANDB_PROJECT=""
...
CLASSES_FILE="/path/to/classfile/classes_esc50.json"
...
NUM_EPOCHS=100                    # ESC-50 converges fast; can reduce to 20 after first run
...
echo "============================================"
echo "  Audio NAPE Base — ESC-50 5-fold CV"
echo "  GPUs:           $NGPU"
